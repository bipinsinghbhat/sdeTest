 ...
 <div className="w-full min-h-[90vh]  border border-1 border-red bg-red-50">
    ...
    <div className="flex w-5/6 mx-auto justify-between " >
      ...
      <div className="w-3/5">
        ...
        <div key={el.id} className="w-full xs:h-80 lg:h-48 border border-4 border-green flex mt-4 bg-red-50 lg:flex-row shadow-lg transition duration-300 ease-in-out transform hover:scale-105">
         ...
         <div className="w-3/4 mt-8  flex items-center justify-between  xs:flex-col " >
            <div className="flex">
      ...
      <div className="w-1/4 h-48 border border-4 border-green mt-4 flex flex-col justify-center items-center bg-red-50">
  <p className="text-xl font-semibold">Total Amount: Rs {TotalAmount()}</p>
  <button onClick={handlenavigate} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-md shadow-md">
  Buy
</button>
</div>
